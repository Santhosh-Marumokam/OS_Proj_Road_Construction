/* Program to demonstrate Road Construction*/


// Team :
// 21JE0526 - MALINI SINGH
// 21JE0529 - MANAKAN ADITYA
// 21JE0546 - MARUMOKAM C V SURYA
// 21JE0553 - MEGH GUPTA
...
using namespace std;
int curt = 0;
/*function to find index of maximum number in an array*/
int pred[20];
int max(int a[], int n)
{
    int max = 0;
